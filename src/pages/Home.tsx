  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content="Create and manage your QR codes quickly and securely."
        />
      </Helmet>
      ...
      <div className="space-y-16">
        <section className="text-center">
          ...
          <p className="text-xl text-gray-600 mb-8 max-w-2xl mx-auto">
            Generate customizable QR codes for your business or personal use.
        ...
        <section className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="bg-white p-6 rounded-lg shadow-md text-center">
            ...
            <p className="text-gray-600">
              Your QR codes are safely stored and easily accessible.
            </p>
          </div>
        ...
        <section className="bg-white p-8 rounded-lg shadow-md">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <p className="text-gray-600">
                Input your URL, text, or contact information.
              </p>
            </div>
            <div className="text-center">
              ...
              <p className="text-gray-600">
                Choose colors, add a logo, and style your QR code.
              </p>
            </div>
            <div className="text-center">
              ...
              <p className="text-gray-600">
                Get your QR code in multiple formats and share instantly.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="bg-white p-8 rounded-lg shadow-md">
          <div className="flex flex-col items-center space-y-6">
            <img src="/logo.png" alt="My brand logo" className="w-48 h-auto" />
            <iframe
              width="560"
              height="315"
            ...
            <p className="text-xl font-semibold">
              Make your life easier using our advanced web-application
            </p>
          </div>
        </section>
      </div>
