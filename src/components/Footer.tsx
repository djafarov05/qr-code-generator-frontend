        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div>
            ...
            <p className="text-gray-600">
              Create beautiful and functional QR codes for your business or personal use.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <a href="/generator" className="text-gray-600 hover:text-indigo-600">
                  Generate QR Code
                </a>
              </li>
              ...
              {isLoggedIn && (
                <>
                  <li>
                    <a href="/my-codes" className="text-gray-600 hover:text-indigo-600">
                      My QR Codes
                    </a>
                  </li>
                  <li>
